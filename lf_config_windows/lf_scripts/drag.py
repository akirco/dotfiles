...
import os
import platform
from tkinterdnd2 import TkinterDnD, DND_FILES, DND_TEXT, ASK, COPY
import sys

from tkinter import Label, Listbox, SEL, END, TkVersion
...
Label(root, text="Drag and drop files here:").grid(row=0, column=0, padx=10, pady=5)
...
#########################################################################
listbox = Listbox(
    root, name="dnd_demo_listbox", selectmode="multiple", width=1, height=1
)
